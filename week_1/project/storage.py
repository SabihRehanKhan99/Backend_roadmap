...
#         self.priority_queue = []  # For priority ordering
#         self.categories: Dict[str, List[str]] = {}
#         self.tags: Dict[str, List[str]] = {}  # New: Track task IDs by tag
...
#         # Updated: Return tasks ordered by priority (lowest priority number first)
#         ordered_tasks = []
